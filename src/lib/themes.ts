...
export const THEMES: Record<string, ThemeDef> = {
  "candela-classic": {
    ...
    preview: { primary: "#1B2B3A", accent: "#E9C03A" },
  ...
  foundation: {
    name: "Foundation",
    preview: { primary: "#2C3E50", accent: "#B8965A" },
  ...
  editorial: {
    name: "Editorial",
    preview: { primary: "#333333", accent: "#8B2252" },
  ...
  civic: {
    name: "Civic",
    preview: { primary: "#3B5068", accent: "#5B8BA0" },
  ...
  blueprint: {
    name: "Blueprint",
    preview: { primary: "#1A3A5C", accent: "#2B8C7E" },
  ...
  momentum: {
    name: "Momentum",
    preview: { primary: "#1B4332", accent: "#74C365" },
  ...
  command: {
    name: "Command",
    preview: { primary: "#2D2D2D", accent: "#D4A843" },
    instructions: `Dark header panel with light text, transitioning to white body. Stats in prominent cards with colored top borders. Bold section headers. Data-forward layout that feels authoritative and confident. Accent color used for key numbers and CTA elements.`,
  },
  aurora: {
    name: "Aurora",
    preview: { primary: "#1A3040", accent: "#3DA0D8" },
  ...
  "neon-civic": {
    name: "Neon Civic",
    preview: { primary: "#0D1B2A", accent: "#00E5FF" },
    instructions: `Bold, high-contrast civic aesthetic. Dark background with bright accent color for all key numbers and section headers. White body text. Feels like an urgent, attention-commanding impact brief. Data pops visually.`,
  },
  obsidian: {
    name: "Obsidian",
    preview: { primary: "#6B6B6B", accent: "#D44040" },
  ...
  void: {
    name: "Void",
    preview: { primary: "#111111", accent: "#C8A84E" },
    instructions: `Alive minimal. Dark background throughout. Light text. Minimal UI — just content and space. Accent color used only for the single most important number on the page. Everything else is quiet. The data speaks.`,
  },
  spectra: {
    name: "Spectra",
    preview: { primary: "#2A1A4E", accent: "#D946A8" },
  ...
  gravity: {
    name: "Gravity",
    preview: { primary: "#3B1520", accent: "#F0F0F0" },
    instructions: `Dramatic and weighty. Full-bleed header section with primary color background and oversized display type (Cormorant Garamond, very large). Body transitions to white. Stats displayed as oversized numbers with small descriptive labels beneath. Feels like a major announcement or campaign launch.`,
  },
  plasma: {
    name: "Plasma",
    preview: { primary: "#1E1440", accent: "#FF3C78" },
    instructions: `Kinetic energy. Use CSS clip-path diagonal cuts between sections to create angular transitions. Primary and accent colors used as section background fills alternating. Bold, offset typography. Feels like motion even in a static document. Stats in offset overlapping blocks.`,
  },
  inferno: {
    name: "Inferno",
    preview: { primary: "#0A0A0A", accent: "#FF6B2B" },
...
export function getThemePreviewColors(themeId: string): ThemePreviewColors {
  const normalized = themeId.replace(/_/g, "-");
  return (
    THEMES[normalized]?.preview ?? THEMES["candela-classic"].preview
  );
}
